...
Let $\mathbf 1_{[-r,r]}$ denote the indicator function on $[-r,r]$. Suppose $u_0$ is a continuous function with compact support, and suppose $u_0$ satisfies $\a \leq u_0(x) \leq \b$ for $|x| \leq r$ and $u_0(x) < \a$ otherwise. It follows that
