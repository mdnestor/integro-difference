...
The reader can easily verify that the Laplace kernel satisfies hypotheses (H1) - (H3); the proof of (H4) is left in the appendix.
...
\end{equation}
This leads to an equation for the mean wave speed
\begin{equation}
c^* = \begin{cases}
